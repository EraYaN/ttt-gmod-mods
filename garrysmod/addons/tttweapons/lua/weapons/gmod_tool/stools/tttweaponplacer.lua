...
local weps = {
   ...
   weapon_ttt_m16 = {name="Colt M-4A1", snd="item_ammo_pistol_ttt"},
   weapon_ttt_ak47 = {name="AK-47", snd="item_ammo_ak47_ttt"},
   weapon_ttt_m3 = {name="FAMAS G1", snd="item_ammo_smg1_ttt"},
   weapon_ttt_m3 = {name="Steyr TMP", snd="item_ammo_smg1_ttt"},
   weapon_ttt_m3 = {name="SIG 550", snd="item_ammo_pistol_ttt"},
   weapon_ttt_m3 = {name="M3", snd="item_box_buckshot_ttt"},   
