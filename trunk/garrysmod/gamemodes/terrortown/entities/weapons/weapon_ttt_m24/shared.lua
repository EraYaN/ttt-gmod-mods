...
if SERVER then
	...
	resource.AddFile("materials/vgui/ttt/icon_bb_m24.vmt")
	...
	resource.AddFile( "materials/models/weapons/w_models/w_snip_m24/bipod.vmt" )
	resource.AddFile( "materials/models/weapons/w_models/w_snip_m24/C3A1_2.vmt" )
	resource.AddFile( "materials/models/weapons/w_models/w_snip_m24/Gucci copy.vmt" )
	resource.AddFile( "materials/models/weapons/w_models/w_snip_m24/M24(2).vmt" )
	resource.AddFile( "materials/models/weapons/w_models/w_snip_m24/M241.vmt" )
	resource.AddFile( "materials/models/weapons/w_models/w_snip_m24/UV1.vmt" )
...
if CLIENT then
	...
	SWEP.Icon = "vgui/ttt/icon_bb_m24"
end
